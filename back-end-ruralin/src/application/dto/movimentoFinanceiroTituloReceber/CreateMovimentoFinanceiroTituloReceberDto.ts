...
/**
 * CreateMovimentoFinanceiroTituloReceberDto - DTO para criação de movimento financeiro de título a receber
 * 
 * DTO usado no endpoint de criação de movimento financeiro de título a receber com todas as validações necessárias.
 ...
 */
export class CreateMovimentoFinanceiroTituloReceberDto extends CreateDto {
  /**
  ...
  @IsNotEmpty({ message: 'ID da parcela do título a receber é obrigatório' })
