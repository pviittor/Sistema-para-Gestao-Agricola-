...
import { ModeloJurosReceber } from '../../../models/TituloReceber';

/**
 * CreateTituloReceberParceladoDto - DTO para criação de título a receber com parcelamento automático
 *
 ...
 */
export class CreateTituloReceberParceladoDto extends CreateTituloReceberDto {
  /**
   ...
   */
  @IsOptional()
  @IsEnum(ModeloJurosReceber, { message: 'Modelo de juros deve ser SIMPLES ou PRICE' })
  modeloJuros?: ModeloJurosReceber;
