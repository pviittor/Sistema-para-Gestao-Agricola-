...
/**
 * ParcelaTituloReceberSemIdDto - DTO para parcela sem idTituloReceber
 *
 * Usado no CreateTituloReceberCompletoDto onde o idTituloReceber será preenchido automaticamente
 */
export class ParcelaTituloReceberSemIdDto {
  /**
   ...
   */
  @IsOptional()
  @IsEnum(StatusParcela, { message: 'Status deve ser ABERTA, PARCIAL, BAIXADA ou CANCELADA' })
