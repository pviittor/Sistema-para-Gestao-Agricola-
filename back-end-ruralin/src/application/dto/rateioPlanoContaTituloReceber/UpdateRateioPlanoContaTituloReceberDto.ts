...
/**
 * UpdateRateioPlanoContaTituloReceberDto - DTO para atualização de rateio por plano de contas de título a receber
 * 
 * DTO usado no endpoint de atualização de rateio por plano de contas de título a receber.
 * Todos os campos são opcionais.
 */
export class UpdateRateioPlanoContaTituloReceberDto extends UpdateDto {
  /**
