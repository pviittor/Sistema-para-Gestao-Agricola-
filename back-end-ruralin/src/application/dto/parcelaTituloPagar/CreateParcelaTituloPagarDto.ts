...
/**
 * CreateParcelaTituloPagarDto - DTO para criação de parcela de título a pagar
 * 
 * DTO usado no endpoint de criação de parcela de título a pagar com todas as validações necessárias.
 */
export class CreateParcelaTituloPagarDto extends CreateDto {
  /**
   * ID do título a pagar ao qual a parcela pertence
   */
