...
/**
 * UpdateParcelaTituloPagarDto - DTO para atualização de parcela de título a pagar
 * 
 * DTO usado no endpoint de atualização de parcela de título a pagar.
 * Todos os campos são opcionais.
 */
export class UpdateParcelaTituloPagarDto extends UpdateDto {
  /**
