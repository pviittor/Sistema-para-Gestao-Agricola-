...
/**
 * UpdateRateioCentroCustoTituloPagarDto - DTO para atualização de rateio por centro de custo de título a pagar
 * 
 * DTO usado no endpoint de atualização de rateio por centro de custo de título a pagar.
 * Todos os campos são opcionais.
 */
export class UpdateRateioCentroCustoTituloPagarDto extends UpdateDto {
  /**
