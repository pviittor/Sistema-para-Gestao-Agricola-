...
/**
 * BaixaParcelaTituloReceberDto - DTO para baixa de parcela de título a receber
 * 
 * DTO usado no endpoint de baixa de parcela de título a receber.
 * Utilizado para realizar a baixa parcial ou total de uma parcela.
 */
export class BaixaParcelaTituloReceberDto {
  /**
   * Data da baixa
   */
