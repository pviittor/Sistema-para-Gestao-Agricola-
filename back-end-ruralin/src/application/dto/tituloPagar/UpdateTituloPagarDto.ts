...
/**
 * UpdateTituloPagarDto - DTO para atualização de título a pagar
 * 
 * DTO usado no endpoint de atualização de título a pagar.
 * Todos os campos são opcionais.
 */
export class UpdateTituloPagarDto extends UpdateDto {
  /**
  ...
  @IsUnique('TituloPagar', 'numeroTitulo', 'id', { message: 'Já existe um título com este número para este tenant' })
  numeroTitulo?: string;
