...
/**
 * RateioCentroCustoSemIdDto - DTO para rateio de centro de custo sem idTituloPagar
 * 
 * Usado no CreateTituloPagarCompletoDto onde o idTituloPagar será preenchido automaticamente
 */
export class RateioCentroCustoSemIdDto {
  /**
