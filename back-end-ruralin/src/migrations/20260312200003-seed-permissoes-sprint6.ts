...
/**
 * Seed de permissões do Sprint 6 OS:
 * - ordemServico.custeio (geração de custeio a partir de OS)
 * - ordemServico.analytics (acesso a analytics/relatórios de OS)
 *
 * Vincula ao perfil ADMIN (mesma lógica do Sprint 5).
 */

const PERMISSOES = [
  'ordemServico.custeio',
  'ordemServico.analytics',
]
